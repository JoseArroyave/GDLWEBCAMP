...
if ($conn->query("SELECT * FROM registrados WHERE id_registrado = $id")->fetch_assoc() === NULL) {
  header('Location:404.php');
}
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="card-body">
          ...
          <form class="form-horizontal" role="form" method="POST" action="modelo-registrado.php" name="guardar-registrado" id="guardar-registrado">
              ...
              <div class=" mb-3 p-3 border border-info rounded">
                <div class="row">
                  ...
                  <div class="col-4">
                    ...
                    <div>
                      <input type="text" class="form-control" id="nombre_registrado" name="nombre_registrado" placeholder="Nombre del usuario a registrar" value="<?php echo $registrado['nombre_registrado'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-4">
                    ...
                    <div>
                      <input type="text" class="form-control" id="apellido_registrado" name="apellido_registrado" placeholder="Apellido del usuario a registrar" value="<?php echo $registrado['apellido_registrado'] ?>">
                    </div>
                  </div>
                  ...
                  <div class="col-4">
                    ...
                    <div>
                      <input type="text" class="form-control" id="email_registrado" name="email_registrado" placeholder="Email del usuario a registrar" value="<?php echo $registrado['email_registrado'] ?>">
                    </div>
                  </div>
              ...
              <div class=" mb-3 p-3 border border-info rounded">
                <div class="row">
                  <div class="col-4">
                    ...
                    <input type="number" class="form-control" min="0" size="3" name="boletos[un_dia][cantidad]" placeholder="0" id="pase_dia" value="<?php echo $articulos['pase_dia'] ?>">
                    <input type="hidden" value="30" name="boletos[un_dia][precio]">
                  </div>
                  <div class="col-4">
                    <p>Todos los días $50</p>
                    <input type="number" class="form-control" min="0" size="3" name="boletos[completo][cantidad]" placeholder="0" id="pase_completo" value="<?php echo $articulos['pase_completo'] ?>">
                    <input type="hidden" value="50" name="boletos[completo][precio]">
                  </div>
                  <div class="col-4">
                    <p>Pase por 2 días (viernes y sábado) $45</p>
                    <input type="number" class="form-control" min="0" size="3" name="boletos[2dias][cantidad]" placeholder="0" id="pase_dosdias" value="<?php echo $articulos['dos_dias'] ?>">
                      ...
                      <div class="col-4">
                        ...
                        <?php foreach ($evento_dia as $evento) { ?>
                          <label style="font-weight:normal;cursor:pointer">
                            <input type="checkbox" name="registro[]" id="<?php echo $evento['id_evento'] ?>" value="<?php echo $evento['clave'] ?>" <?php foreach ($talleres as $taller) {if ($evento['clave'] == $taller) {echo 'checked';}} ?>>
                            <!-- adentro del input va el if para poner checked -->
              ...
              <div class="mb-3 p-3 border border-info rounded">
                <div class="row">
                  ...
                  <div class="col-4">
                    ...
                    <input type="number" min='0' name="pedido_extra[camisas][cantidad]" id='camisa_evento' size='3' placeholder="0" class="form-control" value="<?php echo $articulos['camisas'] ?>">
                  ...
                  <div class="col-4">
                    ...
                    <input type="number" min='0' name="pedido_extra[etiquetas][cantidad]" id='etiquetas' size='3' placeholder="0" class="form-control" value="<?php echo $articulos['etiquetas'] ?>">
            ...
            <div class="card-footer bg-transparent">
              <input type="hidden" name="registrado" value="actualizar">
              <input type="hidden" name="id_registrado" value="<?php echo $id; ?>">
              <button type="submit" id="btnRegistro" class="btn btn-success col-lg-2" value="pagar" name='form'>Actualizar</button>
  ...
  <?php include_once 'templates/footer.php' ?>F